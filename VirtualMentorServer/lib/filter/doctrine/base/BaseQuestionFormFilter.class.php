...
abstract class BaseQuestionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'lessonplan' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('LessonPlan'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      'lessonplan' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('LessonPlan'), 'column' => 'id')),
