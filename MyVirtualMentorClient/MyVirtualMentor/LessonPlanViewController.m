...
- (IBAction)done:(id)sender {
    ...
    [self.delegate createdALessonPlan:self];
}


-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if ([[segue identifier] isEqualToString:@"showCreateALessonPlan"])
    {
        CreateALessonPlanViewController *rvc = [segue destinationViewController];
        rvc.delegate =self;
    }
}
